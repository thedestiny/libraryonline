					...
					<form id="signup" method="post" class="form-horizontal"
						...
						<div class="form-group">
							<label class="col-sm-4 control-label" for="bookpress">Book
								press</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="bookpress"
									name="press" placeholder="press">
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-4 control-label" for="booknum">Book
								number</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" id="booknum" name="num"
